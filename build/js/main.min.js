...
var swiperTours = new Swiper('.swiper-2', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 3,
  spaceBetween: 30,
...
var swiperInstructors = new Swiper('.swiper-3', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 4,
  spaceBetween: 30,
...
var swiperFeedback = new Swiper('.swiper-4', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 'auto',
  spaceBetween: 30,
...
var swiperGallery = new Swiper('.swiper-6', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 'auto',
  spaceBetween: 5,
...
},{"./all-sliders":1,"./map":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./open-burger-menu":13,"./utils/ios-vh-fix":16,"./vendor":18,"./video":22}],3:[function(require,module,exports){
"use strict";
...
if (mapContainer !== null) {
  ...
  var desktopMarker = L.marker(L.latLng(55.816739, 37.63714), {
    icon: L.icon({
...
var listContainer = document.querySelector('.main-header__nav-list-container');
...
},{"./vendor/focus-visible-polyfill":19,"./vendor/leaflet":20,"./vendor/swiper":21}],19:[function(require,module,exports){
"use strict";
