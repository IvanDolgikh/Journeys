...
exports.swiperTours = exports.swiperInstructors = exports.swiperGallery = exports.swiperFeedback = exports.swiper = exports.breakpointChecker = exports.breakpoint = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiper = new _swiper.default('.swiper-1', {
...
var swiperTours = new _swiper.default('.swiper-2', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 3,
  spaceBetween: 30,
...
var swiperInstructors = new _swiper.default('.swiper-3', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 4,
  spaceBetween: 30,
...
var swiperFeedback = new _swiper.default('.swiper-4', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 'auto',
  spaceBetween: 30,
...
var swiperGallery = new _swiper.default('.swiper-6', {
  direction: 'horizontal',
  loop: false,
  slidesPerView: 'auto',
  spaceBetween: 5,
...
var enableSwiperAdvantages = function enableSwiperAdvantages() {
  swiperAdvantages = new _swiper.default('.swiper-5', {
    direction: 'horizontal',
    loop: true,
    slidesPerView: 'auto',
    spaceBetween: 30,
...
},{"../js/vendor/swiper":19}],2:[function(require,module,exports){
"use strict";
...
},{"./all-sliders":1,"./map":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./open-burger-menu":13,"./utils/ios-vh-fix":16,"./video":20}],3:[function(require,module,exports){
"use strict";
...
}).setView([55.817892, 37.634053], 15);
_leaflet.default.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
  maxZoom: 18,
  attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
}).addTo(map);
var desktopMarker = _leaflet.default.marker(_leaflet.default.latLng(55.816739, 37.63714), {
...
var mobileBreakpointChecker = function mobileBreakpointChecker() {
  if (mobileBreakpoint.matches) {
    var mobileIcon = desktopMarker.options.icon;
...
var tabletBreakpoint = window.matchMedia('(min-width:768px) and (max-width:1199px)');
var tabletBreakpointChecker = function tabletBreakpointChecker() {
  if (tabletBreakpoint.matches) {
    var tabletIcon = desktopMarker.options.icon;
...
var desktopBreakpointChecker = function desktopBreakpointChecker() {
  if (desktopBreakpoint.matches) {
    var desktopIcon = desktopMarker.options.icon;
...
},{"./vendor/leaflet":18}],4:[function(require,module,exports){
"use strict";
...
var list = document.querySelector('.main-header__nav-list');
...
var header = document.querySelector('.main-header__info-container');
var contact = document.querySelector('.main-header__contacts-container');
var logoFirst = document.querySelector('.main-header__logo-first');
var logoSecond = document.querySelector('.main-header__logo-second');
...
var onClickLink = function onClickLink(evt) {
